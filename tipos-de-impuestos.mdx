...
- **IVA (7,5%) y IVA (2%) – Tipos temporales/extraordinarios**  
  En los últimos años se han aprobado tipos **reducidos temporales** (7,5%, 2%, etc.) para determinados productos (por ejemplo, ciertos alimentos en periodos inflacionistas).
...
- **IVA (0%) – Tipo 0 sujeto**  
  Se trata de operaciones **sujetas a IVA pero gravadas al 0%** (muy específicas y normalmente temporales).
