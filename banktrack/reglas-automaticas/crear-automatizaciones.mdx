...
description: >-
  Crea reglas automáticas para categorizar, modificar y gestionar tus
  transacciones.
---
...
Para crear una automatización lo primero que debes hacer es dirigirte a la sección de [Reglas automáticas](https://app.banktrack.com/reglas-automaticas). Estas reglas automáticas sirven exclusivamente para modificar transacciones, por el momento no se pueden aplicar a facturas.
